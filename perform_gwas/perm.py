...
def get_k_batch(v, K):
    """
    create tensor containing kinship matrix for each permutation
...
def get_perm_kinships(K, var_comps):
    """
    get tensor containing variance-covariance matrix for each permutation.
...
def get_min_p_value(test_stats, n, freedom_deg):
    ...
    :param freedom_deg: degrees of fredom
